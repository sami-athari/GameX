        ...
        <div class="max-w-4xl mx-auto px-6">
            ...
            <form action="{{ route('user.produk.store') }}" method="POST" enctype="multipart/form-data" class="bg-gaming-card p-6 rounded-xl shadow-lg">
                ...
                <div class="mt-6 text-center">
                    <a href="{{ route('user.produk.index') }}" class="px-6 py-3 btn-gaming text-white rounded-lg hover-lift">
                        <i class="fas fa-arrow-left mr-5"></i> Kembali
                    </a>
                    <button type="submit" class="px-6 py-3 bg-gaming-blue text-white rounded-lg hover:bg-gaming-red-600 hover-lift transition-colors">Tambah Produk</button>
                </div>
            </form>
        </div>
    </section>
