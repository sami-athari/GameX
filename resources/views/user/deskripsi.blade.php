    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="space-y-6">
        ...
        <div class="text-center">
          <span class="text-5xl font-extrabold text-gaming-purple">
        ...
        <form action="{{ route('transaksi.cart') }}" method="GET">
          <button type="submit"
                  class="w-full bg-gaming-purple hover:bg-purple-700 transition py-3 rounded-lg text-white font-semibold">
            Add to Wishlist
          </button>
        </form>
